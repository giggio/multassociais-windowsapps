...
namespace MultasSociais.WinStoreApp.DataModel
{
    ...
    public class SampleDataGroup : SampleDataCommon
    {
        ...
        {
            // Provides a subset of the full items collection to bind to from a GroupedItemsView
    ...
    {
        private static readonly SampleDataSource sampleDataSource = new SampleDataSource();
